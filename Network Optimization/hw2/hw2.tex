...
\paragraph{(c)}
Kruskal's repeatedly applies the blue rule with connected blue components (possibly isolated vertices) on one side of the cut.
Prim's does the same, but always growing the same connected component.
