...
Any subgraph which does not take $x$ is $k$-colorable by copying $G$.
Any subgraph which does not take a pair is $k$-colorable by copying the $(k-1)$-coloring from the corresponding subgraph of $G$
If you remove a $\bar{v}$, you can use the $k-1$ coloring for the rest of the vertices, and use $x$'s color for the remaining $v$.
This gives a $k$-coloring.
If you remove a $v$,
